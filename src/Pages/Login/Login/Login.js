...
const Login = () => {
    ...
    return (
        <div>
            <Header />
            <div style={{ width: '100%', height: '79vh', backgroundColor: 'cornflowerblue' }} className="py-4">
                <div style={loginBg} className="mx-auto form-container my-3 mt-5">
                    <h2 className="text-start text-white">Sign In</h2>
                    <p className="text-start text-white">Please fill-up this form to create an account!</p>
                    <hr className="border" />
