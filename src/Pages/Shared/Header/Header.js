        ...
        <div>
            <nav className="navbar navbar-expand-lg sticky-top navbar-light bg-light">
                <div className="container-fluid">
                    ...
                    <NavLink style={{ color: '#87b106', padding: '10px 15px', borderRadius: '5px' }} className="navbar-brand me-5 fs-4 fw-bold name-title" to="/home">SHOE VALY</NavLink>
