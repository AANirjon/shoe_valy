                ...
                <div style={{ zIndex: '999' }} className="carousel-inner">
                    <div className="carousel-item active">
                        ...
                        <div className="carousel-caption d-none d-md-block carusel-contect">
                            <h1 className="carusel-title">Sneckers</h1>
                            <p className="carusel-caption">Sneakers for Men's like plex...</p>
                    ...
                    <div className="carousel-item">
                        ...
                        <div className="carousel-caption d-none d-md-block carusel-contect">
                            <h1 className="carusel-title">PULLMAN SNEAKER</h1>
                            <p className="carusel-caption">Very comfort Sneakers for anyone...</p>
                    ...
                    <div className="carousel-item">
                        ...
                        <div className="carousel-caption d-none d-md-block carusel-contect">
                            <h1 className="carusel-title">Different Look</h1>
                            <p className="carusel-caption">Different Sneakers for all ages...</p>
                            <button className="explore-btn mt-5">Explore Now</button>
                        </div>
                    </div>
                </div>
