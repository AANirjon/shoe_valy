    ...
    return (
        <div>
            ...
            <div style={bgCover} className="py-5 text-center mb-5">
                ...
                <p className="text-color fs-5">New products are coming very soon....It will look more eye-catching.<br />So, you could get in touch with us to get more fancy shoes...</p>
