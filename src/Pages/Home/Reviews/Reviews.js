...
const Reviews = () => {
    ...
    useEffect(() => {
        fetch('https://ahnaf-shoe.herokuapp.com/reviews')
            .then(res => res.json())
        ...
        <div>
            <div className="bg-light py-5 my-5">
                <div className="text-center mb-5">
                    <h1 className="text-uppercase fw-bold text-primary">What People Think About Us.</h1>
                                ...
                                reviews.length
                                    ...
                                    >
                                        ...
                                        <Card className="border h-75">
                                            <Card.Header style={{ color: '#87b106', fontSize: '20px', backgroundColor: '#223' }}>Website Review ({Math.floor(Math.random() * 100)}) <span><i className="fas fa-users text-primary"></i></span> </Card.Header>
